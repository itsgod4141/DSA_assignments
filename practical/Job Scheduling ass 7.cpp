...
/*
consider a scheduling problem,n tasks to be scheduled on single processor.Let t1,...,tn
be durations required to execute on single processor is known .The tasks can be executed in 
any order but one task at a time.Design a greedy algorithm for this problem
and find schedule that minimizes the total time spent by all the tasks in the system
